...
import CounterPage from "appRenderer/containers/CounterPage"
import { IState } from "appRenderer/reducers"

const CounterPageAny = CounterPage as any
const { configureStore, history } = require("appRenderer/store/configureStore")
