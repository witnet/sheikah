    ...
    const createStatus = (status: status, date: string | undefined) => (
      {
        expired: (
          <p className={styles["expiration-date"]}>
            <span className={styles.red}>Still into force</span>, expiring on {date}
          </p>
        ),
        "still into force": (
          <p className={styles["expiration-date"]}>
            <span className={styles.green}>Expired</span> on {date}
          </p>
        ),
        "never funded": (
          <p className={styles["expiration-date"]}>
            <span className={styles.red}>Never funded</span>
          </p>
        )
      }[status]
    )
